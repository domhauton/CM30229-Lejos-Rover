...
public class RoverManager implements Runnable {
  ...
  public synchronized void panelButtonEvent(ButtonType e) {

    boolean calibrationRequest = e.equals(ButtonType.LEFT) && Button.RIGHT.isDown() ||
            (e.equals(ButtonType.RIGHT) && Button.LEFT.isDown()); // Both left and right pressed.
    boolean exitRequest = e.equals(ButtonType.EXIT);
